...
- Library name: Guiced Vert.x Sockets
- Current/new version: <VERSION>
- Repository URL / path: https://github.com/GuicedEE/GuicedVertxSockets.git
- Rules Rpository Location: rules/generative/backend/guicedee/websockets
- Short description: Provides and configures websocket functionality for GuicedEE applications to consume
- Type:
